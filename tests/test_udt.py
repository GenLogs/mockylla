...
from pyscylladb_mock import mock_scylladb, get_types, get_tables, get_table_rows
...
def test_select_from_table_with_udt():
    ...
    # Assert
    assert len(rows) == 1
    # The driver would typically return a user-defined type instance.
    # Our mock returns a dict, which is a reasonable approximation.
